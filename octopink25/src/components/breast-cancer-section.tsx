  ...
  return (
    <section id="detection" className="section-wrapper">
      ...
      <div className="text-center section-title-spacing">
        <h1 className="font-bold section-title text-pink mb-4 leading-tight animate-fade-in-up">
          {data.title}
        </h1>
        <p className="mx-auto body-large text-text font-normal leading-relaxed max-w-3xl animate-fade-in-up stagger-2">
          {data.subtitle}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-12">
        ...
        {/* Text Content */}
        <div className="space-y-6 order-2 lg:order-1 animate-fade-in-up stagger-3" >
        ...
        {/* Image Container */}
        <div className="relative aspect-[3/4] order-1 lg:order-2 justify-self-end animate-fade-in-up stagger-4
">
